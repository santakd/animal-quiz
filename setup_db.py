...
import hashlib                  # Generates secure hashes and message digests
import logging                  # Records events and errors during execution
import os                       # Interacts with the operating system environment
from pathlib import Path        # Handles filesystem paths using object-oriented classes
import sqlite3                  # Manages and queries SQLite databases
import sys                      # Accesses system-specific parameters and functions
...
# Initializes the database by creating tables and inserting the default admin user.
...
# Ingests images from the image directory into the database.
